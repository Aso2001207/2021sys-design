...
トップページ -right-> お気に入りページ :お気に入りボタンクリック
トップページ :do/商品一覧を表示
商品詳細 --> カート内 :カートに入れるをクリック
商品詳細 --> トップページ :前の画面に戻るをクリック
商品詳細 :do/商品説明を表示
お気に入りページ --> トップページ :トップページをクリック
お気に入りページ --> カート内 :カート内をクリック
お気に入りページ -> 商品詳細 :商品をクリック
お気に入りページ :do/お気に入り商品一覧を表示
カート内 -> 商品詳細 :詳細へをクリック
カート内 -> お気に入りページ :お気に入りページをクリック
